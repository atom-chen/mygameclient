...
class RunFastBaseSeat extends eui.Component {
	protected handCardGroup: RunFastBaseCardGroup;
	protected deskCardGroup: RunFastBaseCardGroup;
	 ...
	 * 清空位子
	 */
	clean(keepCards: boolean, cleanUserInfo: boolean): RunFastBaseSeat {
