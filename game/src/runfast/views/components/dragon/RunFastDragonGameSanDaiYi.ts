 ...
 *
 */
class RunFastDragonGameSanDaiYi extends DragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("sandaiyi",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("sandaiyi",1,1);
    }
