 ...
 *
 */
class RunFastDragonGameSiDaiEr extends DragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("sidaier",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("sidaier",1,1);
    }
