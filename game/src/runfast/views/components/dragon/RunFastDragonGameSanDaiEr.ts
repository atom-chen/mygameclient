 ...
 *
 */
class RunFastDragonGameSanDaiEr extends DragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("sandaier",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("sandaier",1,1);
    }
