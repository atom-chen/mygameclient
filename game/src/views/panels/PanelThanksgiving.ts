...
class PanelThanksgiving extends alien.PanelBase {
    private static _instance: PanelThanksgiving;
	/**
	 * 购买按钮
	 */
    ...
    init():void {
		this.skinName = panels.PanelThanksgivingSkin;
	...
	private _onClickBuyImg():void{
		...
		RechargeService.instance.doRecharge(_productId);
	}
	...
	private _onRemovedToStage():void{
		...
		PanelThanksgiving._instance = null;
	}
	/**
	 * 使能 事件
	 */
	 ...
	 * 获取感恩节单例
	 */
    public static getInstance(): PanelThanksgiving {
        if(!PanelThanksgiving._instance) {
            PanelThanksgiving._instance = new PanelThanksgiving();
        }
        return PanelThanksgiving._instance;
    }
	/**
	 * 移除感恩节面板
	 */
	public static remove():void{
		if(PanelThanksgiving._instance){
			PanelThanksgiving._instance.close();
		}
	}
}