...
class PanelMatchIntro extends alien.PanelBase {
	private static _instance:PanelMatchIntro;
	public static get instance():PanelMatchIntro {
		if (this._instance == undefined) {
			this._instance = new PanelMatchIntro();
		}
	...
	protected init():void {
		this.skinName = panels.PanelMatchIntroSkin;
	}
