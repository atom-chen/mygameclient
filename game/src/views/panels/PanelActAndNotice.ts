...
class PanelActAndNotice extends alien.PanelBase {
    private static _instance: PanelActAndNotice;
	 ...
	 * 活动模块
	 */
	private _act:PanelAct;

	/**
	 * 公告模块
	 */
	private _notice:PanelNotice;
    ...
    init():void {
		this.skinName = panels.PanelActAndNotice;
	}
	...
	private _checkAct():void{
		if(!this._act){
			this._act = PanelAct.getInstance();
	...
	private _checkNotice():void{
		if(!this._notice){
			this._notice = PanelNotice.getInstance();
	 ...
	 * 显示钻石首充
	 */
	public showDFRecharge():void{
		this.showAct();
		this._act.setShowDFirstRecharge();
	}
	...
	private _onRemovedToStage():void{
		...
		PanelActAndNotice._instance = null;
	}
	/**
	 * 使能 事件
	 */
	 ...
	 * 获取活动公告单例
	 */
    public static getInstance(): PanelActAndNotice {
        if(!PanelActAndNotice._instance) {
            PanelActAndNotice._instance = new PanelActAndNotice();
        }
        return PanelActAndNotice._instance;
    }
	...
	public static remove():void{
		if(PanelActAndNotice._instance){
			PanelActAndNotice._instance.close();
		}
	}
}