...
class PanelGetRed extends alien.PanelBase {
    private static _instance: PanelGetRed;
    ...
    init():void {
		this.skinName = panels.PanelGetRedSkin;
	}
    ...
    private _onClickGetRed():void{
        ExchangeService.instance.doChou(this._roomId);
    }
	 ...
	 * 获取抽红包单例
	 */
    public static getInstance(): PanelGetRed {
        if(!PanelGetRed._instance) {
            PanelGetRed._instance = new PanelGetRed();
        }
        return PanelGetRed._instance;
    }
