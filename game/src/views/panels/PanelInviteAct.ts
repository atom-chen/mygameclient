...
class PanelInviteAct extends alien.PanelBase {
    private static _instance: PanelInviteAct;
    ...
    init():void {
		this.skinName = panels.PanelInviteActSkin;
	}
	...
	private _formatEveryTaskData():any{
		...
		let _inviteTask:any = GameConfig.getCfgByField("dbs_config.invite_active");
	...
	private _initDefaut():void{
	    ...
	    this.taskList.itemRenderer = IRContainer;
   ...
   /**
	 ...
	 * 获取邀请活动单例
	 */
    public static getInstance(): PanelInviteAct {
        if(!PanelInviteAct._instance) {
            PanelInviteAct._instance = new PanelInviteAct();
        }
        return PanelInviteAct._instance;
    }
	...
	public static remove():void{
		if(PanelInviteAct._instance){
			PanelInviteAct._instance.close();
		}
	}
}