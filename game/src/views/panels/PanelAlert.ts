...
class PanelAlert extends alien.PanelBase {
	private static _instance:PanelAlert;
	public static get instance():PanelAlert {
		if (this._instance == undefined) {
			this._instance = new PanelAlert();
		}
...
class Alert {
	static show(content:string, type:number = 0, callback:Function = null,textAlign:string = "center",textFlow:Array<egret.ITextElement> = null):void {
		PanelAlert.instance.show(content, type, callback, textAlign,textFlow);
	}
