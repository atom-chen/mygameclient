...
class PanelFollowCourse extends alien.PanelBase {
    private static _instance: PanelFollowCourse;
    public static get instance(): PanelFollowCourse {
        if(this._instance == undefined) {
            this._instance = new PanelFollowCourse();
        }
    ...
    protected init(): void {
        this.skinName =  panels.PanelFollowCourseSkin;
    }
	...
	private _onRemovedToStage():void{
		...
		PanelFollowCourse._instance = null;
	}
    /**
     * 点击复制微信公众号
     */
    private _onClickCopyWX():void{
        GameConfig.copyText(this.parent,"好手气斗地主","公众号(好手气斗地主)");
    }
}