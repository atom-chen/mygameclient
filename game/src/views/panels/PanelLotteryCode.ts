...
class PanelLotteryCode extends alien.PanelBase {
    private static _instance: PanelLotteryCode;
    ...
    init():void {
		this.skinName = panels.PanelLotteryCodeSkin;
	}
	...
	private _initUI():void{
		this.codeList.itemRenderer = CodeItem;
	...
	private _onRemovedToStage():void{
		...
		PanelLotteryCode._instance = null;
	}
	...
	private _showLotteryRule():void{
		...
		+"每一次投入最大次数限制为" + GameConfig.lotteryMaxNum + "次，可重复投入。\n"
	 ...
	 * 获取我的夺宝码
	 */
    public static getInstance(): PanelLotteryCode {
        if(!PanelLotteryCode._instance) {
            PanelLotteryCode._instance = new PanelLotteryCode();
        }
        return PanelLotteryCode._instance;
    }
	...
	public static remove():void{
		if(PanelLotteryCode._instance){
			PanelLotteryCode._instance.close();
		}
	}
}
 ...
 * 我的夺宝码
 */
class CodeItem extends eui.ItemRenderer {
