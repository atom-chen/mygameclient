 ...
 *
 */
class DragonHongBao extends DragonBase {
    ...
    private btn:StateButton;
    public constructor() {
        super("hongbao");
        this.armature1 = this.addArmature("hongbao");
        this.armature2 = this.addArmature("hongbao");
        this.btn = new StateButton();
        this.btn.skinName = ui.PlayOrangeButtonSkin;
...
//        this.play2();
    ...
    private stop1(): void {     
        ...
        this.armature1.animation.gotoAndStop("hongbao1",1); 
    ...
    private stop2(): void {      
        ...
        this.armature2.animation.gotoAndStopByFrame("hongbao2",1);
    ...
    public play1(isPlay:boolean): void {
        ...
        if (isPlay)
        {
            this.armature1.animation.gotoAndPlayByFrame("hongbao1",1,1);
            this.armature1.addEventListener(egret.Event.COMPLETE,this.onComplete1.bind(this),this);
        }
        else
            this.armature1.animation.gotoAndPlayByFrame("hongbao1",55,1);
    }
//    342 21
    public play2(): void {
        this.stop1();
         ...
         * zhu 新手王炸胜利红包界面
         */
        this._closeImg = new eui.Image("common_close_n");
        ...
        this.armature2.animation.gotoAndPlayByFrame("hongbao2",1,1);
    }
