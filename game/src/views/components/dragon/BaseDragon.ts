 ...
 *
 */
class DragonBase extends egret.Sprite {
    public constructor(resName:string) {
        ...
        DragonManager.getInstance().addDragon(dragonbonesData,texture,textureData);
    }
    ...
    {
        var armature: dragonBones.Armature = DragonManager.getInstance().getDragon(armatureName);
