 ...
 *
 */
class LoadingProcess extends eui.Component{
	public constructor() {
    	super();
...
//      timer.start();
    ...
    private static instance: LoadingProcess;
    public static getInstance(): LoadingProcess {
        if(!this.instance)
            this.instance = new LoadingProcess();
