 ...
 *
 */
class RedRankInfo extends eui.ItemRenderer {
    public constructor() {
        super();
    }
    ...
    protected dataChanged(): void {
        ...
        if(this.data) {
            ...
            if(uid == MainLogic.instance.selfData.uid) {
            ...
            this.score.text = Utils.exchangeRatio(this.data.score/100,true);
...
window["RedRankInfo"]=RedRankInfo;