...
class FeiHistoryItem extends eui.ItemRenderer {
    ...
    protected dataChanged(): void {
        ...
        let format = alien.TimeUtils.timeFormatForEx(dateTime,"-","-","",false);
        this.exTimeLabel.text = "兑换日期:  " + format;
        
        this.typeImg.source = (this.data.goodsid == 3 ? "room_3" : "exchange_" + this.data.goodsid);       
    ...
    public setHasShowGetCourse():void{
        PanelExchange2.setHasShowClickCourse();
        this._showCourse(false);
    }
    ...
    private _initStatus():void{
        ...
        if(_status == 3 ){
            this.statusBgImg.source = "common_btn_orange3";
            ...
            if(_goodsId == 5 || _goodsId == 6 || _goodsId == 3){
                ...
                this.statusBgImg.source = "common_btn_orange2_gray";
    ...
    private _onClickStatus():void{
        ...
        if(_status == 3 || _status == 4 ){
            PanelFeiEx.getInstance().show(_d);
        }
    }
