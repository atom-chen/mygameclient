...
public class LoginByMobile extends TimerTask implements AuthenticateSubView {
    ...
    public LoginByMobile(final Activity activity, final AuthenticateManager manager, FrameLayout container) {
        ...
        contentView = (RelativeLayout)inflater.inflate(R.layout.login_by_mobile, null);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mobile.length() == 0 || code.length() == 0){
                    ...
                    manager.showWaiting();
                    WebService.getInstance().loginByMobile(
