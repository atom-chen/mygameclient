...
class FishProtoIDs {
	static getMap():any{
        ...
        //捕鱼
        protoIDs[2050] = "game.STCGameFishTrace"
        protoIDs["game.STCGameFishTrace"] = 2050
        protoIDs[2051] = "game.CTSGameFishNum"
        protoIDs["game.CTSGameFishNum"] = 2051
        protoIDs[2052] = "game.CTSGameFishFire"
        protoIDs["game.CTSGameFishFire"] = 2052
        protoIDs[2053] = "game.STCGameFishFire"
        protoIDs["game.STCGameFishFire"] = 2053
        protoIDs[2054] = "game.CTSGameFishCatch"
        protoIDs["game.CTSGameFishCatch"] = 2054
        protoIDs[2055] = "game.STCGameFishOver"
        protoIDs["game.STCGameFishOver"] = 2055
        protoIDs[2056] = "game.STCGameFishScreenFish"
        protoIDs["game.STCGameFishScreenFish"] = 2056
        protoIDs[2057] = "game.STCGameFishSetAI"
        protoIDs["game.STCGameFishSetAI"] = 2057
        protoIDs[2058] = "game.STCGameFishConfig"
        protoIDs["game.STCGameFishConfig"] = 2058
        protoIDs[2059] = "game.STCGameFishRedCount"
        protoIDs["game.STCGameFishRedCount"] = 2059
        protoIDs[2060] = "game.STCGameFishFireFail"
        protoIDs["game.STCGameFishFireFail"] = 2060
        protoIDs[2061] = "game.CTSGameFishBindPhoneReward"
        protoIDs["game.CTSGameFishBindPhoneReward"] = 2061
        protoIDs[2062] = "game.STCGameFishBindPhoneReward"
        protoIDs["game.STCGameFishBindPhoneReward"] = 2062
        protoIDs[2063] = "game.CTSGameFishFreshenGold"
        protoIDs["game.CTSGameFishFreshenGold"] = 2063
        protoIDs[2064] = "game.STCGameFishFreshenGold"
        protoIDs["game.STCGameFishFreshenGold"] = 2064
