...
class CCCard extends egret.DisplayObjectContainer {
	private _container: egret.DisplayObjectContainer;
	private _body: CCCardBody;
	...
	private init(): void {
		...
		this._container.addChild(this._body = new CCCardBody());
	 ...
	 * @returns {CCCard}
	 */
	static create(data): CCCard {
		return <CCCard>CCalien.ObjectPool.getObject('CCCard', data);
	}
	...
	static recycle(instance): void {
		CCalien.ObjectPool.recycleObject('CCCard', instance);
	}
