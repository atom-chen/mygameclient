 ...
 * 用户数据
 */
let _encrypt = CCalien.Encrypt.encryptStr;
let _decrypt = CCalien.Encrypt.encryptStr;

class CCGlobalUserData extends CCGlobalDataStorage {
	private static _instance: CCGlobalUserData;
	public static get instance(): CCGlobalUserData {
		if (this._instance == undefined) {
			this._instance = new CCGlobalUserData();
		}
