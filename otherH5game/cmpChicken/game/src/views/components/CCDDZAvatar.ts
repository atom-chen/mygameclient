...
class CCDDZAvatar extends eui.Component {
	private imgMask:eui.Image;
	private imgAvatar:eui.Image;
	public bg_img:eui.Image; //背景
	...
	private _showVipGrp(bShow:boolean):void{
		this["vipGrp"].visible = bShow;
	}
...
window["CCDDZAvatar"]=CCDDZAvatar;