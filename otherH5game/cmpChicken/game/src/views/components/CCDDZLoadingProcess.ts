 ...
 *
 */
class CCDDZLoadingProcess extends eui.Component{
	public constructor() {
    	super();
...
//      timer.start();
    ...
    private static instance: CCDDZLoadingProcess;
    public static getInstance(): CCDDZLoadingProcess {
        if(!this.instance)
            this.instance = new CCDDZLoadingProcess();
