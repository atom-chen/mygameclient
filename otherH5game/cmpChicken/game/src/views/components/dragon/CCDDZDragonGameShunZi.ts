 ...
 *
 */
class CCDDZDragonGameShunZi extends CCDDZDragonBase {
    private armature: dragonBones.Armature;
    private needMinnor: boolean;
    public constructor(needMinnor: boolean) {
        super("cc_gm_shunziliandui");
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("shunzi",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("shunzi",1,1);
    }
