 ...
 *
 */
class CCDDZDragonGameChunTian extends CCDDZDragonBase{
    private armature: dragonBones.Armature;
	public constructor() {
        super("cc_gm_chuntian");
        this.armature = this.addArmature("cc_gm_chuntian");
	}
    ...
    public stop(): void {        
        this.armature.animation.gotoAndStopByFrame("cc_gm_chuntian",1);
    }

    public play(): void {
        this.armature.addEventListener(egret.Event.COMPLETE,this.onComplete.bind(this),this);
        this.armature.animation.gotoAndPlayByFrame("cc_gm_chuntian",1,1);
    }
