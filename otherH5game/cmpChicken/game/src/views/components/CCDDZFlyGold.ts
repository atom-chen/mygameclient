 ...
 *
 */
class CCDDZFlyGold extends eui.Component{
	public constructor() {
    	super();
    	this.skinName=components.CCDDZFlyGoldSkin;
	}
...
//        CurveModifiers.init();
	 ...
	 * 工厂方法，创建飞行金豆
	 * @param data
	 * @returns {CCDDZFlyGold}
	 */
	static create(data):CCDDZFlyGold {
		return <CCDDZFlyGold>CCalien.ObjectPool.getObject('CCDDZFlyGold', data);
	}
	...
	static recycle(instance):void {
		CCalien.ObjectPool.recycleObject('CCDDZFlyGold', instance);
	}
...
window["CCDDZFlyGold"]=CCDDZFlyGold;