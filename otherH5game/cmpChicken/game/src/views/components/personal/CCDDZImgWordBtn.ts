...
class CCDDZImgWordBtn extends eui.Component {
    /**
     * 背景图
     */
    ...
    public setDisable():void{
        ...
        this.bgImg.source = "cc_common_btn_orange2_gray";
        this.useNewTit();
    }
    ...
    public setEnable():void{
        this.bgImg.source = "cc_common_btn_orange2_n";
        this.infoGroup.touchEnabled = true;
        this.touchEnabled = true;
        this.useNewTit();
    }
}
window["CCDDZImgWordBtn"]=CCDDZImgWordBtn;