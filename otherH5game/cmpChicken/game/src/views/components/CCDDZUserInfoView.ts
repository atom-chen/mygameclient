...
class CCDDZUserInfoView extends eui.Component {
    public labNickName: eui.Label;
    public gold: CCDDZGold;
    public diamond: CCDDZGold;
    public avatar: CCDDZAvatar;
...
window["CCDDZUserInfoView"] = CCDDZUserInfoView;