...
class CCDDZCDProgressBar extends eui.Component {
	...
	play(duration:number, delay:number = 0){
		...
		this._timer = CCDDZCountDownService.register(duration, this.onSecond.bind(this));
...
window["CCDDZCDProgressBar"]=CCDDZCDProgressBar;