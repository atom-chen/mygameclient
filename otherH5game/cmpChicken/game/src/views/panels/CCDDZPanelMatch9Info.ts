...
class CCDDZPanelMatch9Info extends CCalien.CCDDZPanelBase {
    private static _instance: CCDDZPanelMatch9Info;
    ...
    init():void {
		this.skinName = panels.CCDDZPanelMatch9Info;
	}
	...
	private _onRemovedToStage():void{
		...
		CCDDZPanelMatch9Info._instance = null;
	}
	/**
	 * 使能 事件
	 */
	 ...
	 * 获取9人钻石赛详情单例
	 */
    public static getInstance(): CCDDZPanelMatch9Info {
        if(!CCDDZPanelMatch9Info._instance) {
            CCDDZPanelMatch9Info._instance = new CCDDZPanelMatch9Info();
        }
        return CCDDZPanelMatch9Info._instance;
    }
	...
	public static remove():void{
		if(CCDDZPanelMatch9Info._instance){
			CCDDZPanelMatch9Info._instance.close();
		}
	}
}