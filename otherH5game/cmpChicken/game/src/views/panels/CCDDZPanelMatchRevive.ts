...
class CCDDZPanelMatchRevive extends CCalien.CCDDZPanelBase {
    private static _instance: CCDDZPanelMatchRevive;
    ...
    init():void {
		this.skinName = panels.CCDDZPanelMatchRevive;
	}
	...
	private _onRemovedToStage():void{
		...
		CCDDZPanelMatchRevive._instance = null;
	}
	/**
	 * 使能 事件
	 */
	 ...
	 * 获取复活单例
	 */
    public static getInstance(): CCDDZPanelMatchRevive {
        if(!CCDDZPanelMatchRevive._instance) {
            CCDDZPanelMatchRevive._instance = new CCDDZPanelMatchRevive();
        }
        return CCDDZPanelMatchRevive._instance;
    }
	...
	public static remove():void{
		if(CCDDZPanelMatchRevive._instance){
			CCDDZPanelMatchRevive._instance.close();
		}
	}
}