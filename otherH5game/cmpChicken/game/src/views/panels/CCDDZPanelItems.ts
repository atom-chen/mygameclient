...
class CCDDZPanelItems extends CCalien.CCDDZPanelBase {
	private static _instance:CCDDZPanelItems;
	public static get instance():CCDDZPanelItems {
		if (this._instance == undefined) {
			this._instance = new CCDDZPanelItems();
		}
	...
	protected init():void {
		this.skinName = panels.CCDDZPanelItemsSkin;
	...
	createChildren():void {
		...
		this.goodsList.itemRenderer = CCDDZGoodsItemRender;
	...
	static getInstance():CCDDZPanelItems{
		return this._instance;
	}
}

class CCDDZGoodsItemRender extends eui.ItemRenderer{
