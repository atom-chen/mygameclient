...
class PDKPanelGetRed extends PDKalien.PDKPanelBase {
    private static _instance: PDKPanelGetRed;
    ...
    init():void {
		this.skinName = panels.PDKPanelGetRedSkin;
	}
    ...
    private _onClickGetRed():void{
        PDKExchangeService.instance.doChou(this._roomId);
    }
	 ...
	 * 获取抽红包单例
	 */
    public static getInstance(): PDKPanelGetRed {
        if(!PDKPanelGetRed._instance) {
            PDKPanelGetRed._instance = new PDKPanelGetRed();
        }
        return PDKPanelGetRed._instance;
    }
	...
	public static remove():void{
		if(PDKPanelGetRed._instance){
			PDKPanelGetRed._instance.close();
		}
	}
}