...
class PDKImgToast extends eui.Component {
	private static _instance:PDKImgToast;
	public static get instance():PDKImgToast {
		if (this._instance == undefined) {
			this._instance = new PDKImgToast();
		}
	...
	protected init():void {
		this.skinName = personal.PDKToastSkin;
	}
