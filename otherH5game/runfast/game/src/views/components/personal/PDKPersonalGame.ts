 ...
 *
 */
class PDKPersonalGame extends PDKalien.PDKNavigationPage {
    ...
    protected init():void {
        this.skinName = personal.PDKPersnalGameSkin;
	}
    ...
    protected onJoin(e:egret.TouchEvent):void{
        PDKJoinTable.instance.show();
    }

    protected onHitory(e:egret.TouchEvent):void{
        PDKPersonalGameHistory.instance.clearDataList();
        PDKPersonalGameHistory.instance.getDataList();
        PDKHistoryRecord.instance.show(PDKPersonalGameHistory.instance.source);
    }
}
