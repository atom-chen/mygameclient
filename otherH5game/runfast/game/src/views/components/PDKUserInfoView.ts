...
class PDKUserInfoView extends eui.Component {
    public labNickName: eui.Label;
    public gold: PDKGold;
    public diamond: PDKGold;
    public avatar: PDKAvatar;
    ...
    update(data: PDKUserInfoData): void {
    ...
    updateNickname(data: any): void {
        ...
        if (data.uid == _selfData.uid) {
            if (_selfData.nickname) {
                // console.log("updateNickname--------->",_selfData.nickname )
    ...
    updateHeadImage(imageid: string): void {
        ...
        // else {
        //     this.avatar.imageId = 'pdk_icon_head_default';
        // }
    }
