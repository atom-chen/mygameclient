 ...
 *
 */
class PDKDragonGameZhaDan extends PDKDragonBase {
    private armature: dragonBones.Armature;
    public constructor() {
        super("pdk_gm_zhadan");
        this.armature = this.addArmature("pdk_gm_zhadan");
    }
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("pdk_gm_zhadan",1);
    }

    public play(): void {
        this.armature.addEventListener(egret.Event.COMPLETE,this.onComplete.bind(this),this);
        this.armature.animation.gotoAndPlayByFrame("pdk_gm_zhadan",1,1);
    }
