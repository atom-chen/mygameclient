 ...
 *
 */
class PDKDragonGameSiDaiEr extends PDKDragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("pdk_sidaier",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("pdk_sidaier",1,1);
    }
