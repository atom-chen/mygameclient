 ...
 *
 */
class PDKDragonGameSanDaiYi extends PDKDragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("pdk_sandaiyi",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("pdk_sandaiyi",1,1);
    }
