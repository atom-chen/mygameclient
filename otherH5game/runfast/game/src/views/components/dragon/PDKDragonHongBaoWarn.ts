 ...
 *
 */
class PDKDragonHongBaoWarn extends PDKDragonBase {
    ...
    protected onResize(e: egret.Event): void {
        this.x = PDKalien.StageProxy.stage.stageWidth *0.5+424;
        this.y = PDKalien.StageProxy.stage.stageHeight *0.5 +16;
    }
