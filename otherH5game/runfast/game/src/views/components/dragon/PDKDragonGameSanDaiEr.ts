 ...
 *
 */
class PDKDragonGameSanDaiEr extends PDKDragonBase {
    ...
    public stop(): void {
        this.armature.animation.gotoAndStopByFrame("pdk_sandaier",1);
    }
    ...
    public play(): void {
        ...
        this.armature.animation.gotoAndPlayByFrame("pdk_sandaier",1,1);
    }
