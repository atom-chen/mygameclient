...
class PDKChatList extends eui.Component {
	...
	protected init():void {
		this.skinName = components.PDKChatListSkin;
	}

	createChildren():void {
		super.createChildren();

		this.list.itemRenderer = PDKIRUpDownIcon;
		this.list.dataProvider = new eui.ArrayCollection(PDKlang.chatList);
